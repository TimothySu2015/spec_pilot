...
describe('EdgeCaseGenerator', () => {
  ...
  describe('字串長度邊界測試', () => {
    it('應該產生 maxLength 測試', () => {
      ...
      expect(maxLengthStep?.expect.statusCode).toBe(200);
    });
    ...
    it('應該產生超過 maxLength 測試', () => {
      ...
      expect(exceedStep?.expect.statusCode).toBe(400);
    });
    ...
    it('應該產生 minLength 測試', () => {
      ...
      expect(minLengthStep?.expect.statusCode).toBe(200);
    });
  ...
  describe('數值範圍邊界測試', () => {
    it('應該產生 integer minimum 測試', () => {
      ...
      expect(age).toBe(0);
      expect(minStep?.expect.statusCode).toBe(200);
    });
    ...
    it('應該產生 integer maximum 測試', () => {
      ...
      expect(age).toBe(150);
      expect(maxStep?.expect.statusCode).toBe(200);
    });
  ...
  describe('FlowStep 結構', () => {
    it('應該產生正確的 FlowStep 結構', () => {
      ...
      expect(step.expect).toHaveProperty('statusCode');
    });
  ...
  describe('整合測試', () => {
    it('應該能處理複雜的 schema', () => {
      ...
      steps.forEach((step) => {
        ...
        expect(step.expect.statusCode).toBeGreaterThanOrEqual(200);
        expect(step.expect.statusCode).toBeLessThan(500);
      });
    });
