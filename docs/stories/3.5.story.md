...
```javascript
// 連線與通訊處理
function sendRequest(method, params) { /* 實作 */ }

// 四個 MCP 方法的測試函式
function testListSpecs() { /* 實作 */ }
function testListFlows() { /* 實作 */ }
function testRunFlow() { /* 實作 */ }
function testGetReport() { /* 實作 */ }

// 主執行邏輯
async function main() { /* 執行所有測試 */ }
```
